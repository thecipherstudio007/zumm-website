...
export default function HealthcareSolution() {
  ...
  return (
    <div className="w-full">
      ...
      <section className="py-20 bg-slate-50/50 dark:bg-gray-900/20 border-y border-slate-200 dark:border-gray-800">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            >
              <h3 className="text-3xl font-bold text-slate-900 dark:text-white mb-8 border-b border-slate-200 dark:border-gray-800 pb-4 font-display">
                ...
                {pillars.map((pillar, idx) => {
                  ...
                  return (
                    <div key={idx} className="flex gap-4 group">
                      <div className="mt-1 shrink-0 w-12 h-12 rounded-2xl bg-white dark:bg-gray-900 border border-slate-200/60 dark:border-white/5 flex items-center justify-center text-blue-600 dark:text-blue-400 group-hover:scale-110 transition-transform shadow-sm">
            ...
            <motion.div 
              ...
              className="relative bg-white dark:bg-[#0B1120] rounded-3xl border border-slate-200/50 dark:border-gray-800 p-6 md:p-8 overflow-hidden shadow-2xl shadow-slate-200/40 dark:shadow-none"
            >
              {/* Tabs for Visualization */}
              <div className="flex gap-2 mb-8 bg-slate-50 dark:bg-gray-900/50 p-1.5 rounded-xl border border-slate-200 dark:border-gray-800 w-max overflow-x-auto max-w-full">
                <button 
                  onClick={() => setActiveTab(0)}
                  className={`px-4 py-2 rounded-lg text-sm font-semibold transition-all whitespace-nowrap ${activeTab === 0 ? 'bg-blue-600 text-white' : 'text-slate-500 hover:text-slate-900 dark:hover:text-white'}`}
                >
                  Patient Timeline
                </button>
                <button 
                  onClick={() => setActiveTab(1)}
                  className={`px-4 py-2 rounded-lg text-sm font-semibold transition-all whitespace-nowrap ${activeTab === 1 ? 'bg-emerald-600 text-white' : 'text-slate-500 hover:text-slate-900 dark:hover:text-white'}`}
                >
                  Structured Extraction
                </button>
              </div>

              <div className="h-auto min-h-[420px] relative">
                <AnimatePresence mode="wait">
                  {activeTab === 0 && (
                    ...
                    >
                      ...
                      {[
                        ...
                        >
                          <div className="flex items-center justify-center w-10 h-10 rounded-full border border-white dark:border-gray-900 bg-blue-100 dark:bg-blue-900/50 text-blue-600 dark:text-blue-400 shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2 z-10 shadow-sm">
                            <CheckCircle2 className="w-5 h-5" />
                          </div>
                          <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-slate-50 dark:bg-gray-900 p-4 rounded-2xl border border-slate-200 dark:border-gray-800 group-hover:border-blue-500/50 transition-colors">
                  ...
                  {activeTab === 1 && (
                    ...
                    >
                      <div className="flex-1 bg-slate-50 dark:bg-gray-900 border border-slate-200 dark:border-gray-800 rounded-2xl p-4 md:p-5 overflow-hidden flex flex-col">
                        <div className="flex items-center justify-between mb-4 pb-4 border-b border-slate-200 dark:border-gray-800">
                         ...
                         <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 flex-1">
                            ...
                            <motion.div 
                              ...
                              className="bg-white dark:bg-[#0F172A] rounded-xl p-4 border border-slate-200 dark:border-white/5 shadow-sm"
                            >
                            ...
                            >
                              ...
                              <div className="space-y-2">
                                 <div className="flex justify-between items-center"><span className="text-sm text-slate-600 dark:text-gray-300 whitespace-nowrap overflow-hidden text-ellipsis mr-2">Hypertension</span><span className="text-[10px] font-mono bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 px-1.5 py-0.5 rounded shrink-0">ICD-10: I10</span></div>
                                 <div className="flex justify-between items-center"><span className="text-sm text-slate-600 dark:text-gray-300 whitespace-nowrap overflow-hidden text-ellipsis mr-2">Type 2 DM</span><span className="text-[10px] font-mono bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 px-1.5 py-0.5 rounded shrink-0">ICD-10: E11.9</span></div>
                              </div>
                            </motion.div>
                            ...
                            <motion.div 
                              ...
                              animate={{ opacity: 1, y: 0 }}
                              transition={{ delay: 0.3 }}
                              className="sm:col-span-2 bg-[#1E293B] rounded-xl p-4 mt-2 overflow-hidden border border-slate-700/50 shadow-inner"
                            >
                              <h5 className="text-xs uppercase tracking-wider text-slate-400 font-semibold mb-2">Automated JSON Payload</h5>
                              <pre className="text-[10px] sm:text-xs font-mono text-emerald-400 overflow-x-auto whitespace-pre-wrap">
{`{
  "patient_id": "P-98421",
