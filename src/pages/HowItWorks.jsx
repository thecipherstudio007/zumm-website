  ...
  const content = {
    healthcare: {
      step1: {
        ...
        items: ['Text is cleaned and optimized', 'Pages are indexed for navigation', 'Document cached for reuse']
      },
      step2: {
        prompt: 'Scan the entire document and locate all key medical sections — map each to its page range.',
        mapping: [
        ...
        lanes: [
          {
            ...
            prompt: 'Identify liability limits and exclusionary clauses from the policy document.',
    ...
    legal: {
      ...
      step2: {
        prompt: 'Perform legal document mapping for Witness Testimony, Expert Evidence, Trial Motions, and Exhibits.',
        mapping: [
        ...
        <div className="max-w-7xl mx-auto relative group">
          ...
          <div className="space-y-20 lg:space-y-40">
            ...
            <div ref={step1Ref} className="grid grid-cols-[100px_1fr] lg:grid-cols-[120px_1fr] gap-4 lg:gap-0 items-start group">
              ...
              <StepCard
                step="01"
                title={industry === 'legal' ? 'Legal Document Upload' : industry === 'insurance' ? 'Claim File Upload' : 'Document Upload'}
              ...
              >
                <p className="text-slate-600 dark:text-gray-400 leading-relaxed mb-6">
                  {industry === 'legal' ? 'Upload trial briefs, depositions, or case files. Zumm securely cleans and indexes the legal text for precision extraction.' : 
                   ...
                   'Upload your medical document once. Zumm securely receives it, cleans the text, and prepares it for intelligent processing.'}
                </p>
                  ...
                  <div className="space-y-5">
                    ...
                    <p className="text-sm text-slate-600 dark:text-gray-400 leading-relaxed">
                      {industry === 'legal' ? 'The AI indexes the entire legal brief once to identify key sections like witness testimony and case law.' : 
                       ...
                       'The AI reads through your entire document once and creates a structured map — identifying exactly where each type of medical data lives.'}
                    </p>
                  </div>

                  {/* Right: Output */}
                  <OutputPanel label="Document Map" icon={Map}>
            ...
            {[
              {
                ...
                desc: 'Your document is cached after the first read. Every subsequent step reuses cached tokens instead of reprocessing — saving significant cost.'
              },
              {
                icon: ShieldCheck,
      ...
      <section className="py-24 px-6 relative">
        ...
        >
          ...
          <p className="text-lg text-slate-600 dark:text-gray-400 leading-relaxed mb-10 max-w-xl mx-auto">
            Upload a document and watch our pipeline extract structured clinical data in minutes — not hours.
          </p>
